...
export type ProductQuery = { __typename?: 'QueryRoot', product?: (
    { __typename?: 'Product', media: { __typename?: 'MediaConnection', nodes: Array<{ __typename: 'ExternalVideo' } | { __typename: 'MediaImage', id: string, mediaContentType: MediaContentType, image?: { __typename?: 'Image', altText?: string | null, height?: number | null, id?: string | null, url: any, width?: number | null } | null } | { __typename: 'Model3d' } | { __typename: 'Video' }> }, variants: { __typename?: 'ProductVariantConnection', nodes: Array<(
        { __typename?: 'ProductVariant' }
        & { ' $fragmentRefs'?: { 'ProductVariantFieldsFragment': ProductVariantFieldsFragment } }
      )> } }
    & { ' $fragmentRefs'?: { 'ProductFieldsFragment': ProductFieldsFragment } }
  ) | null };

export type ProductFieldsFragment = { __typename?: 'Product', handle: string, id: string, title: string, vendor: string, options: Array<{ __typename?: 'ProductOption', name: string, values: Array<string> }> } & { ' $fragmentName'?: 'ProductFieldsFragment' };

export type ProductVariantFieldsFragment = { __typename?: 'ProductVariant', availableForSale: boolean, id: string, title: string, compareAtPriceV2?: { __typename?: 'MoneyV2', currencyCode: CurrencyCode, amount: any } | null, image?: { __typename?: 'Image', altText?: string | null, height?: number | null, id?: string | null, url: any, width?: number | null } | null, priceV2: { __typename?: 'MoneyV2', currencyCode: CurrencyCode, amount: any }, selectedOptions: Array<{ __typename?: 'SelectedOption', name: string, value: string }> } & { ' $fragmentName'?: 'ProductVariantFieldsFragment' };
